...
<head>
    ...
    <title>Level 5 | BMC Virtual Christmas Game 2021</title>
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1 id="header5" class="text-danger">Level - 5</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="input-states">
                                        <form class="form-horizontal">
                                            <div class="form-group has-success">
                                                <div class="row">
                                                    <div class="col-md-2">
                                                    <img class="img-fluid" src="assets/images/counting.jpg" alt="counting" />
                                                    </div>
                                                    <div class="col-md-6">
                                                    <h5> Options: </h5>
                                                        <br>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="level1Radio" id="level5_choice4">
                                                        <label class="form-check-label" for="level5_choice4">
                                                        <h4>38</h4>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="level1Radio" id="level5_choice5">
                                                        <label class="form-check-label" for="level5_choice5">
                                                        <h4>39</h4>
                                                        </label>
                                                    </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col text-center">
                                            <button id="level5" class="btn btn-md btn-rounded btn-primary">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
