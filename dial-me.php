                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1 id="header20" class="text-danger">Level - 20</h1>
                            </div>
                        </div>
                    </div>
                </div>
                <section id="main-content">
                            <div class="card mx-auto">
                                <div class="card-title">
                                    <h1 class="text-danger">I am the number you dial when you need technical as<u>s</u>istance.</h1>
                                </div>
                                <div class="card-body">
                                <div class="input-states">
                                        <form class="form-horizontal">
                                            <div class="form-group has-success">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                    <img class="img-fluid" src="assets/images/rotary-phone.jpg" alt="A Woman on the Phone"/>
                                                    </div>
                                                    <div class="col-md-6">
                                                    <h5> Options: </h5>
                                                        <br>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="level1Radio" id="level20_choice1">
                                                        <label class="form-check-label" for="level20_choice1">
                                                        <h4>2578</h4>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                    ...
                                    <div class="row">
                                        <div class="col text-center">
                                            <button id="level20" class="btn btn-md btn-rounded btn-primary">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
