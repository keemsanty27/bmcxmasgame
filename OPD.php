                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1 id="header6" class="text-danger">Level - 6</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="input-states">
                                        <form class="form-horizontal">
                                            <div class="form-group has-success">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                    <img class="img-fluid" src="assets/images/opd.jpg" alt="OPD" />
                                                    </div>
                                                    <div class="col-md-6">
                                                    <h5> Options: </h5>
                                                        <br>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="level1Radio" id="level6_choice2">
                                                        <label class="form-check-label" for="level6_choice2">
                                                        <h4>Registering at BMC OPD's Hospital Information Management System</h4>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                    ...
                                    <div class="row">
                                        <div class="col text-center">
                                            <button id="level6" class="btn btn-md btn-rounded btn-primary">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
